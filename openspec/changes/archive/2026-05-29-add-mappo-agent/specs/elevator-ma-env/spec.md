...
## Purpose
The Multi-Agent elevator environment capability wraps the building elevator simulator to expose local observation dictionary and receive bidding action dictionary from all elevator agents.
