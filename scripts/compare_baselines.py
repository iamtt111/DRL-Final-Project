...
def main():
    ...
    if plot_paths:
        if "tradeoff" in plot_paths:
            ...
            report_content.append("*   **Pareto 最優性**：從 AWT vs ERT 的二維散點圖可以看出，Nearest Car 落在局部貪婪的極端，而 PPO 與 SARSA 嚴重偏離前沿，唯有 **MAPPO 完美落在 Pareto 效率前沿 (Pareto Frontier) 上**，證明其多智能體架構能有效解決動作空間爆炸，取得全域最佳權衡。")
            report_content.append("")
